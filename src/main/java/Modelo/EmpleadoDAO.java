...
public class EmpleadoDAO {
    ...
    public Empleado validar(String user, String dpi){
        ...
        try {
            ...
            while(rs.next()){
                ...
                em.setNom(rs.getString("vendedor"));
    ...
    public int agregar(Empleado em){
        String sql ="insert into empleado(dpi,vendedor,telefono,estado,user)values(?,?,?,?,?);";
        try {
            con=cn.Conexion();
            ps=con.prepareStatement(sql);
    ...
    public int  actualizar(Empleado em){
        String sql ="update empleado set dpi=?,vendedor=?,telefono=?,estado=?,user=? where id=?;";
        try {
            con=cn.Conexion();
            ps=con.prepareStatement(sql);
            ps.setString(1, em.getDpi());
